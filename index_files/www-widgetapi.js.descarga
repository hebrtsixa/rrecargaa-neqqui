...
function ka(a){if(a.j)throw new TypeError("Generator is already running");a.j=!0}
y.prototype.s=function(a){this.l=a};
function la(a,b){a.i={P:b,R:!0};a.g=a.m||a.u}
y.prototype.return=function(a){this.i={return:a};this.g=this.u};
function z(a,b,c){a.g=c;return{value:b}}
function ma(a){this.g=new y;this.h=a}
function na(a,b){ka(a.g);var c=a.g.h;if(c)return oa(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.g.return);
a.g.return(b);return B(a)}
function oa(a,b,c,d){try{var e=b.call(a.g.h,c);if(!(e instanceof Object))throw new TypeError("Iterator result "+e+" is not an object");if(!e.done)return a.g.j=!1,e;var k=e.value}catch(g){return a.g.h=null,la(a.g,g),B(a)}a.g.h=null;d.call(a.g,k);return B(a)}
function B(a){for(;a.g.g;)try{var b=a.h(a.g);if(b)return a.g.j=!1,{value:b.value,done:!1}}catch(c){a.g.l=void 0,la(a.g,c)}a.g.j=!1;if(a.g.i){b=a.g.i;a.g.i=null;if(b.R)throw b.P;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
function pa(a){this.next=function(b){ka(a.g);a.g.h?b=oa(a,a.g.h.next,b,a.g.s):(a.g.s(b),b=B(a));return b};
this.throw=function(b){ka(a.g);a.g.h?b=oa(a,a.g.h["throw"],b,a.g.s):(la(a.g,b),b=B(a));return b};
this.return=function(b){return na(a,b)};
this[Symbol.iterator]=function(){return this}}
function qa(a){function b(d){return a.next(d)}
function c(d){return a.throw(d)}
return new Promise(function(d,e){function k(g){g.done?d(g.value):Promise.resolve(g.value).then(b,c).then(k,e)}
k(a.next())})}
function C(a){return qa(new pa(new ma(a)))}
...
var vb=/#|$/;function wb(){var a;return C(function(b){a=document.createElement("iframe");a.style.display="none";bb(a,Ya("https://www.google.com"));document.body.appendChild(a);return b.return(new Promise(function(c,d){a.onload=function(){var e=navigator.cookieEnabled;a.remove();c(e)};
a.onerror=function(e){a.remove();d(e)}}))})}
;var xb=["https://www.google.com"];function yb(){var a=this;this.g=[];this.h=function(){Promise.all(a.g.map(function(b){document.requestStorageAccessFor(b)})).then(function(){window.removeEventListener("click",a.h)})}}
function zb(){return C(function(a){if(a.g==1)a=z(a,wb(),2);else if(a.l)a=a.return(!1);else{var b=a.return;var c=Ua()>=119;a=b.call(a,c&&!!navigator.permissions&&!!navigator.permissions.query&&"requestStorageAccessFor"in document)}return a})}
function Ab(){var a=new yb,b=["https://www.youtube.com"];b=b===void 0?xb:b;C(function(c){switch(c.g){case 1:return z(c,zb(),2);case 2:if(!c.l){c.g=3;break}return z(c,Promise.all(b.map(function(d){var e;return C(function(k){if(k.g==1)return k.m=2,z(k,navigator.permissions.query({name:"top-level-storage-access",requestedOrigin:d}),4);k.g!=2?(e=k.l,e.state==="prompt"&&a.g.push(d),k.g=0,k.m=0):(k.m=0,k.i=null,k.g=0)})})),4);
case 4:a.g.length>0&&window.addEventListener("click",a.h);case 3:return c.return()}})}
;var W={},Bb=[],V=new U,Cb={};function Db(){for(var a=v(Bb),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function Fb(a){V.H.apply(V,arguments)}
...
function Hb(a,b,c){Y||(Y={},Ib=new Set,Jb.addEventListener("message",function(d){a:if(Ib.has(d.origin)){try{var e=JSON.parse(d.data)}catch(f){break a}var k=Y[e.id];if(k&&d.origin===k.O)switch(d=k.U,d.s=!0,d.s&&(I(d.m,d.sendMessage,d),d.m.length=0),k=e.event,e=e.info,k){case "apiInfoDelivery":if(F(e))for(var g in e)e.hasOwnProperty(g)&&(d.v[g]=e[g]);break;case "infoDelivery":Kb(d,e);break;case "initialDelivery":F(e)&&(clearInterval(d.i),d.playerInfo={},d.v={},Lb(d,e.apiInterface),Kb(d,e));break;default:d.j.i||
(g={target:d,data:e},d.j.H(k,g),Fb("player."+k,g))}}}));
a=String(X(a,"host"));Y[c]={U:b,O:a};Ib.add(a)}
var Y=null,Ib=null,Jb=window;function Mb(a){return(a.search("cue")===0||a.search("load")===0)&&a!=="loadModule"}
function Nb(a){return a.search("get")===0||a.search("is")===0}
;var Ob=window;
function Z(a,b){this.v={};this.playerInfo={};this.videoTitle="";this.l=this.g=this.h=null;this.i=0;this.s=!1;this.m=[];this.j=null;this.B={};if(!a)throw Error("YouTube player element ID required.");this.id=sa(this);b=Object.assign({title:"video player",videoId:"",width:640,height:360},b||{});var c=document;if(a=typeof a==="string"?c.getElementById(a):a)if(Ob.yt_embedsEnableRsaforFromIframeApi&&Ab(),c=a.tagName.toLowerCase()==="iframe",b.host||(b.host=c?sb(a.src):"https://www.youtube.com"),this.h=
new Gb(b),c||(b=Pb(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.g=a,this.g.id||(this.g.id="widget"+sa(this.g)),W[this.g.id]=this,window.postMessage){this.j=new U;Qb(this);b=X(this.h,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Cb)Cb.hasOwnProperty(e)&&Rb(this,e)}}
...
if(!c)return this;this.j.subscribe(a,c);Sb(this,a);return this};
function Rb(a,b){b=b.split(".");if(b.length===2){var c=b[1];"player"===b[0]&&Sb(a,c)}}
...
a=""+X(a.h,"host")+("/embed/"+X(a.h,"videoId"))+"?"+ub(g);Ob.yt_embedsEnableIframeSrcWithIntent?(bb(c,Ya(a)),c.sandbox.add("allow-presentation","allow-top-navigation")):c.src=a;return c}
p.G=function(){this.g&&this.g.contentWindow?this.sendMessage({event:"listening"}):clearInterval(this.i)};
function Qb(a){Hb(a.h,a,a.id);a.i=setInterval(a.G.bind(a),250);a.g&&(a.u=function(){clearInterval(a.i);a.i=setInterval(a.G.bind(a),250)},a.g.addEventListener("load",a.u))}
function Sb(a,b){a.B[b]||(a.B[b]=!0,Tb(a,"addEventListener",[b]))}
...
function Ub(a){var b=X(a.h,"playerVars");if(b){var c={},d;for(d in b)c[d]=b[d];b=c}else b={};window!==window.top&&document.referrer&&(b.widget_referrer=document.referrer.substring(0,256));if(a=X(a.h,"embedConfig")){if(F(a))try{a=JSON.stringify(a)}catch(e){console.error("Invalid embed config JSON",e)}b.embed_config=a}return b}
function Kb(a,b){if(F(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.g.setAttribute("title",b))):(a.videoTitle="",a.g.setAttribute("title","YouTube "+X(a.h,"title"))))}}
function Lb(a,b){I(b,function(c){this[c]||(c==="getCurrentTime"?this[c]=function(){var d=this.playerInfo.currentTime;if(this.playerInfo.playerState===1){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;e>0&&(d+=Math.min(e,1))}return d}:Mb(c)?this[c]=function(){this.playerInfo={};
this.v={};Tb(this,c,arguments);return this}:Nb(c)?this[c]=function(){var d=0;
c.search("get")===0?d=3:c.search("is")===0&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){Tb(this,c,arguments);
return this})},a)}
...
H("YT.scan",Db);H("YT.subscribe",function(a,b,c){V.subscribe(a,b,c);Cb[a]=!0;for(var d in W)W.hasOwnProperty(d)&&Rb(W[d],a)});
...
Bb.push(function(a){var b=a;b||(b=document);a=Ba(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var k={};for(c=d=0;b=e[c];c++){var g=b.className,f;if(f=typeof g.split=="function")f=ya(g.split(/\s+/),
"yt-player")>=0;f&&(k[d++]=b)}k.length=d;b=k}}b=Ba(b);I(Aa(a,b),Vb)});
